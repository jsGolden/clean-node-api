...
describe('SignUp Controller', () => {
  ...
  test('Should call EmailValidator with corrrect email', async () => {
    const { sut, emailValidatorStub } = makeSut()
  ...
  test('Should call AddAcount with corrrect values', async () => {
    const { sut, addAccountStub } = makeSut()
  ...
  test('Should call Validation with corrrect value', async () => {
